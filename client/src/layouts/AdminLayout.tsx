        ...
        <div className="admin-cont layout">
            <header>
                ...
                <div className="right-cont header-part">
                    <button id="documentation" className="btn-1" onClick={ () => navigate('documentation') }>
                        Documentation
                    </button>
                    <a href="tel:19253561014">
                        <button id="support" className="btn-2">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" aria-label="support" role="img">
